...
def prehisto(name,labelsy,coloursy):
	...
	plt.plot(xsone,ysone,label=labelsy,color=coloursy)
	plt.scatter(name,y,color=coloursy)



if __name__ == "__main__":
	import sys
	prehisto(str(sys.argv[1]),str(sys.argv[2]),str(sys.argv[3]))
